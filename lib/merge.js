 ...
 */
export function resolveTroops(baseUnits, troopRefs, rosterSlots, tribeId, tribeTraining) {
 ...
 * @param {{ tribes?: Record<string, Record<string, object>> }} [tribeTraining]
 */
export function resolveTribe(tribeFile, baseUnits, roster, tribeTraining) {
  const tribeId = tribeFile.tribe.id;
  const troops = resolveTroops(baseUnits, tribeFile.troops, roster.slots, tribeId, tribeTraining);
