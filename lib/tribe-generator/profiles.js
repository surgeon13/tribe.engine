...
export const CULTURE_PROFILES = [
  ...
  },
  {
    ...
    theme: "Cheap shambling masses, spectral scouts, and bone cavalry — high pressure, fragile line",
    historicalContext:
      "A necromantic host of raised dead, wights, and cursed riders. Fantasy faction (not historical): expendable infantry waves supported by dread cavalry and siege engines hauled by the damned.",
    keywords: [
      "undead",
      "undead tribe",
      "zombie",
    ...
    troops: {
      inf_t1: {
        name: "Skeleton Levy",
        description: "Rattling bone levy — cheap, numerous, and brittle.",
        stats: { attack: 30, defenseInfantry: 28, defenseCavalry: 25, speed: 6, carry: 40 },
        cost: { wood: 85, clay: 70, iron: 95, crop: 25 },
        cropUpkeep: 1,
      },
      inf_t2: {
        name: "Ghoul",
        description: "Flesh-hungry raiders — fast aggression, thin armor.",
        stats: { attack: 55, defenseInfantry: 28, defenseCavalry: 22, speed: 8, carry: 35 },
        cost: { wood: 115, clay: 95, iron: 130, crop: 45 },
        cropUpkeep: 1,
      },
      inf_t3: {
        name: "Wight",
        description: "Grave-bound elites with chill blades — strong punch, still fragile.",
        stats: { attack: 80, defenseInfantry: 40, defenseCavalry: 30, speed: 7, carry: 40 },
        cost: { wood: 150, clay: 135, iron: 200, crop: 75 },
        cropUpkeep: 1,
      },
      scout: {
        name: "Shade",
        description: "Spectral scout — nearly unseen on the march.",
        stats: { attack: 0, defenseInfantry: 18, defenseCavalry: 10, speed: 18, carry: 0 },
        cost: { wood: 120, clay: 140, iron: 20, crop: 35 },
        cropUpkeep: 2,
      },
      cav_t1: {
        name: "Bone Rider",
        description: "Skeletal light horse — cheap mounted pressure.",
        stats: { attack: 105, defenseInfantry: 45, defenseCavalry: 40, speed: 15, carry: 90 },
        cost: { wood: 430, clay: 360, iron: 280, crop: 85 },
        cropUpkeep: 3,
      },
      cav_t2: {
        name: "Death Knight",
        description: "Cursed heavy cavalry — dread charge.",
        stats: { attack: 175, defenseInfantry: 70, defenseCavalry: 90, speed: 11, carry: 65 },
        cost: { wood: 520, clay: 590, iron: 740, crop: 170 },
        cropUpkeep: 4,
      },
      cav_t3: {
        name: "Black Steed",
        description: "Night-mares of the necropolis — balanced undead horse.",
        stats: { attack: 145, defenseInfantry: 65, defenseCavalry: 75, speed: 13, carry: 75 },
        cost: { wood: 500, clay: 520, iron: 640, crop: 145 },
        cropUpkeep: 4,
      },
      ram: {
        name: "Bone Ram",
        description: "Siege engine lashed from ossuary timber and bone.",
        stats: { attack: 65, defenseInfantry: 28, defenseCavalry: 70, speed: 4, carry: 0 },
        cost: { wood: 850, clay: 340, iron: 480, crop: 65 },
        cropUpkeep: 3,
      },
      catapult: {
        name: "Tomb Catapult",
        description: "Hurls crypt-stone and grave rubble.",
        stats: { attack: 78, defenseInfantry: 55, defenseCavalry: 10, speed: 3, carry: 0 },
        cost: { wood: 920, clay: 1300, iron: 580, crop: 85 },
        cropUpkeep: 6,
      },
      chief: {
        name: "Lich",
        description: "Undying warlock who binds settlements to the grave-realm.",
        stats: { attack: 45, defenseInfantry: 35, defenseCavalry: 28, speed: 4, carry: 0 },
        cost: { wood: 29500, clay: 26500, iron: 43000, crop: 35000 },
        cropUpkeep: 5,
      },
      settler: {
        name: "Necropolis Settler",
        description: "Raise a new crypt-colony from barren ground.",
        stats: { attack: 0, defenseInfantry: 75, defenseCavalry: 75, speed: 5, carry: 3000 },
        cost: { wood: 5600, clay: 5100, iron: 7000, crop: 5300 },
        cropUpkeep: 1,
      },
    },
    hero: {
      ...
      description: "Champion of the grave — leads the undead host.",
      stats: { attack: 125, defenseInfantry: 95, defenseCavalry: 90, speed: 9, carry: 100 },
      cropUpkeep: 6,
    },
  },
];
