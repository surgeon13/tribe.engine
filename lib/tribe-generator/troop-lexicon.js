...
export const CULTURE_LEXICONS = [
  ...
  },
  {
    ...
    units: {
      inf_t1: ["Bondi", "Spearman", "Shield Bearer", "Leidang Spearman", "Bondi Militia"],
      inf_t2: ["Archer", "Skirmisher", "Axeman", "Bogemann", "Viking Skirmisher"],
      inf_t3: ["Huscarl", "Berserker", "Hirdman", "Varangian", "Huskarl", "Varangian Guard", "Ulfhednar"],
      scout: ["Coast Watcher", "Tracker"],
      cav_t1: ["Shore Rider", "Light Horse", "Hestmann", "Shore Raider"],
  ...
  },
  {
    ...
    units: {
      inf_t1: ["Spearman", "Militia", "Muster Footman", "Pikeman", "Spearmen", "Burgher Militia", "Pavise Spearman"],
      inf_t2: ["Longbowman", "Crossbowman", "Billman", "Archer", "Yeoman Archer", "Genoese Crossbowman", "Halberdier"],
      inf_t3: ["Man-at-Arms", "Sergeant", "DisMounted Knight", "Men-at-Arms", "Sergeant-at-Arms", "Knight Errant"],
      scout: ["Scout", "Forester", "Outrider"],
      cav_t1: ["Hobelar", "Light Horse", "Mounted Sergeant", "Hobelars", "Coursers"],
      cav_t2: ["Knight", "Lancer", "Heavy Cavalry", "Lances Fournies", "Gendarme"],
  ...
  },
  {
    ...
    label: "Early Slavic",
    years: [500, 1200],
    match: ["slav", "slavic", "slavs", "rus", "kievan", "druzhina", "polans", "wend", "wends", "polish", "serb", "bulgarian"],
    archetype: "infantry",
    palette: { primary: "#1B3A4B", secondary: "#8B9A6B" },
    era: "Early medieval Slavic",
    region: "Eastern Europe",
    units: {
      inf_t1: ["Spearman", "Peasant Militia", "Shield Bearer"],
      inf_t2: ["Archer", "Javelin Skirmisher", "Axeman"],
      inf_t3: ["Druzhina", "Bogatyr", "Heavy Infantry"],
      scout: ["Forest Scout", "Tracker", "Border Watch"],
      cav_t1: ["Light Rider", "Mounted Scout"],
      cav_t2: ["Druzhina Cavalry", "Lancer"],
      cav_t3: ["Boyar Cavalry", "Princely Guard"],
      ram: ["Timber Ram", "Siege Ram"],
      catapult: ["Stone Thrower", "Mangonel", "Trebuchet"],
      chief: ["Knyaz", "Voivode", "Chieftain"],
      settler: ["Village Settler"],
      hero: ["Hero"],
    },
  },
