...
export const TRIBE_IDENTITIES = Object.freeze({
  roman: {
    slotRoles: {
      ...
      scout: "scout",
      cav_t1: "cav_off",
      // Rome had three offensive horses and the middle one was best at
      // nothing: slower and lighter than the Imperatoris, and outclassed on
      // every combat stat by the Regales. A legion is a hammer and an anvil,
      // so the slot becomes the anvil — heavy cataphract-style cavalry that
      // holds a line, the way a Haeduan or a Paladin does for its tribe.
      cav_t2: "cav_def",
      cav_t3: "cav_off",
    },
    shape: { infAtk: 1.02, infDef: 1.06, cavAtk: 1.04, cavDef: 1.06, speed: 0.95, carry: 0.95 },
    slotShapes: {
      // A cataphract: slow, armoured, and bought to hold ground rather than
      // take it. It still hauls, because def-cavalry that cannot raid just
      // gets parked as a wall (data/balance/TROOP_ROLES.md).
      cav_t2: { cavDef: 1.35, cavAtk: 0.8, speed: 0.85, carry: 0.75 },
    },
    eliteness: 1.08,
    centerpiece: 1.5,
    cropPressure: 1.06,
