...
export const TRIBE_IDENTITIES = Object.freeze({
  ...
  undead: {
    tier: "boss",
    // The foot had off_inf twice, which cannot work: the two slots differ only
    // by tier multiplier, so the skeleton was the wight with smaller numbers and
    // no reason to exist. One role per axis instead — hauler, wall, blade.
    slotRoles: {
      inf_t1: "line",
      inf_t2: "def_inf",
      inf_t3: "off_inf",
